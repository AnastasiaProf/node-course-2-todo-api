...
//deletes all the todos before running tests
// beforeEach(done => {
  ...
  it("should create a user", done => {
    ...
    request(app)
      ...
      .expect(res => {
        ...
        expect(res.body.email).toBe("ex@ex.com");
      })
      .end(err => {
        if (err) {
          return done(err);
        ...
        User.findOne({ email: "ex@ex.com" }).then(user => {
